    ...
    details: [
      ...
      },
      {
        ...
        items: [
          ...
          "Built an AI-powered book discovery assistant by integrating the weekly updated New York Times best seller books API with Google Gemini, enabling real-time awareness of trending and popular books through dynamic context injection.",
        ],
      },
    ],
    tags: [
