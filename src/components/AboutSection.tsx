      ...
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-muted-foreground">
              I'm passionate about building elegant, efficient solutions. I
              continuously learn new frontend and backend techniques to ensure
              everything I create is functional, optimized, and built with best
              practices.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4 justify-center">
              ...
              <a
                href="/Bang-Kim-Do-Resume.pdf"
                download={"Bang-Kim-Do-Resume.pdf"}
